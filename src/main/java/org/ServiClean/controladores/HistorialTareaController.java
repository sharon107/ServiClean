...
public class HistorialTareaController {
    ...
    @Autowired
    private IHistorialTareaService historialTareaService;
    ...
    public String index(Model model,
        ...
        Page<HistorialTarea> historialTareas = historialTareaService.buscarTodosPaginados(pageable);
        model.addAttribute("historialTareas", historialTareas);

        int totalPages = historialTareas.getTotalPages();
        if (totalPages > 0) {
